...
public class Constant {
    ...
    //
    public static final String AUTHORITY = "net.braingang.houndlib.dbprovider";

    //
    public static final String COGNITO_POOL_ID = "bogus";

    //
    public static final String BUCKET_NAME = "bogus";
}